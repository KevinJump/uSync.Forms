...
namespace uSync.Forms.Dependencies
{
    public class FormsDataSourceDependencyChecker : ISyncDependencyChecker<FormDataSource>
    {
        ...
        private IEnumerable<uSyncDependency> GetDependencies(FormDataSource item, DependencyFlags flags)
        {
        ...
        public Task<IEnumerable<uSyncDependency>> GetDependenciesAsync(FormDataSource item, DependencyFlags flags)
